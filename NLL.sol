...
contract CryptoPhunksMarket is ReentrancyGuard, Pausable {
    ...
    modifier onlyOwner {
        require(msg.sender == cloner || msg.sender == Ownable(cloner).owner(), "not the cloner or owner");
        _;
    }

    IERC721 phunksContract;     // instance of the CryptoPhunks contract
    address cloner;     // instance of the cloner
    ...
    function phunksAddress() external view returns (address) {
